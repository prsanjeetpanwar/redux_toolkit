    ...
    <nav className="relative flex w-full flex-wrap items-center justify-between bg-[#FBFBFB] py-2 text-neutral-500 shadow-lg hover:text-neutral-700 focus:text-neutral-700 dark:bg-neutral-600 lg:py-4">
      <div className="ml-5 flex w-[30%] items-center justify-between">
        ...
        <span className="input-group-text flex items-center whitespace-nowrap rounded px-3 py-1.5 text-center text-base font-normal text-neutral-700 dark:text-neutral-200" id="basic-addon2">
          ...
          <Link to='/' className=" text-black mr-3 py-1.5 px-3 rounded bg-primary text-white hover:bg-primary-light
           focus:bg-primary-light dark:bg-primary-dark dark:text-white-dark">Create Post</Link>

<Link to='/read' className="text-black py-1.5 px-3 rounded bg-primary text-white hover:bg-primary-light focus:bg-primary-light
 dark:bg-primary-dark dark:text-white-dark">View All Posts</Link>
        </span>
      </div>
